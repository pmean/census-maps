...
Finally, this program will read data from the American Community Survey, download information from the Census website, and re-allocate values to individual community districts and neighhorhoods.
...
The st_intersections function will evaluate to TRUE if two shapefiles intersect. The st_area function will give the area of a shapefile and the st_intersection function will produce a new shapefile from the intersection of two shapefiles.
...
This work will take advantage of the read_acs library.
